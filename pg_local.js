...
FROM (
    ...
    WHERE 
        ...
        AND svc.data_documento BETWEEN '2025-11-01' AND '2025-11-30'
    GROUP BY 
        vcp.codigo_lancamento,
        la.descricao,
        svc.codigo_usuario,
    ...
    WHERE 
        ...
        AND lr.data_lancamento BETWEEN 
            '2025-11-01 00:00:00' AND '2025-11-30 23:59:59'
    GROUP BY 
        lr.codigo_usuario,
    ...
    WHERE 
        ...
        AND vcss.data_lancamento BETWEEN '2025-11-01' AND '2025-11-30'
    GROUP BY 
        vcss.codigo_usuario,
