...
FROM (
    ...
    GROUP BY 
        vcp.codigo_lancamento, la.descricao, svc.codigo_usuario, svc.data_documento
    ...
    WHERE 
        CAST(est.data_movimentacao AS DATE) BETWEEN '2025-12-01' AND '2025-12-31'
    GROUP BY 
        est.codigo_usuario, est.data_movimentacao
    ...
    WHERE 
        ...
        AND la.alinea = 'C'
        AND lr.data_lancamento BETWEEN '2025-12-01 00:00:00' AND '2025-12-31 23:59:59'
    GROUP BY 
    ...
    GROUP BY 
        vcss.codigo_usuario, vcss.data_lancamento
    ...
    WHERE 
        ...
        AND svc.data_documento BETWEEN '2025-12-01' AND '2025-12-31'
    GROUP BY 
        svc.codigo_usuario, svc.data_documento
...
GROUP BY 
    tipo, codigo_lancamento, descricao
ORDER BY 
    tipo, descricao;
  `);
